#ifndef KUDOS_KBDREG_H
#define KUDOS_KBDREG_H
...
#define	 KBS_AUXD	0x20	/* kbd auxiliary data in buffer */
#define	 KBS_RERR	0x40	/* kbd receive error */
#define	 KBS_PERR	0x80	/* kbd parity error */

#define	KBCMDP		0x64	/* kbd controller port(O) */
#define	 KBC_READMODE	0x20	/* read mode */
#define	 KBC_WRITEMODE	0x60	/* write mode */
