#ifndef KUDOS_INC_PMAP_H
#define KUDOS_INC_PMAP_H
 ...
 *     map pages there if desired.  KudOS user programs map pages temporarily
 *     at UTEMP.
 */


// All physical memory mapped at this address.
// If you want to change it, make sure to change the load address in
// kern/kernel.ld appropriately, as well as the --adjust-vma parameter to
// objcopy in kern/KMakefrag (which should sum to 0 with KERNBASE).
...
// A special struct Page.pp_ref value indicating the page is a kern boot page.
// Do not depend on this for correctness, envs can spoof it!
#define KERNBOOT_PPREF 65432
