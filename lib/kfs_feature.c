...
const feature_t KFS_feature_uid = {id: 0x00000006, optional: 0, warn: 0, description: "Owner ID"};
const feature_t KFS_feature_gid = {id: 0x00000007, optional: 0, warn: 0, description: "Group ID"};
const feature_t KFS_feature_unix_permissions = {id: 0x00000008, optional: 0, warn: 0, description: "Standard Unix Permissions"};
...
const feature_t KFS_feature_symlink = {id: 0x0000000C, optional: 0, warn: 0, description: "Symbolic Link Name"};
